...
//일반 사용자용
public class BoardImpl_false implements Board {
   //static int board_no = 0;
   //static int reply_no = 0;
...
//         System.out.println("=============================================================================================================================================================================");
   ...
   public BoardVO writeBoard() {
      ...
      System.out.println("자바파일을 업로드하겠습니까?");
      ...
      //   글의 작성자아이디와 로그인한 아이디가 일치하면 게시글 수정을 보여줌
         if(board.getMember_id().equals(Database.tb_login.getMember_id())){
            ...
            case 5:
               ...
               ReplyVO tmp_reply = boardDao.getReplyMember(reply_no); //댓글 작성자 아이디와 접속한 사람의 아이디 비교
               if(!Database.tb_login.getMember_id().equals(tmp_reply.getMember_id())){
                  print(50);
                  System.out.println("댓글의 작성자가 아닙니다.");
                  break;
               }
         ...
         else{// 상세보기한 글과 작성자가 다르면 글 수정기능과 삭제 기능이 없음
            
            System.out.print("1.댓글 작성");
